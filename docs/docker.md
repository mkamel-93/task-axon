...
|---------|-----------|----------|--------------------------------|
| PHP/App | `{APP_NAME}_php` | `172.22.0.11` | `make php-bash`                |
| Web/Nginx | `{APP_NAME}_web` | `172.22.0.12` | Port 80, 5173                  |
| Redis | `{APP_NAME}_redis` | `172.22.0.16` | Port 6379                      |

This ensures reliable inter-container communication for services like:
- PHP connecting to Redis (`REDIS_HOST=172.22.0.16` || `REDIS_HOST=redis` service name)
