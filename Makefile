...
.PHONY: symlink init-env sync-env destroy build rebuild-container \
        up down restart conf ps php-bash web-bash logs logs-watch test \
        test-pint test-phpstan test-phpunit-coverage reset-ide-helper reset-data fix-lint
